...
export const usePortfolioGsap = () => {
  ...
  const initAnimations = () => {
    ...
    ctx = gsap.context(() => {
      ...
      const heroContent = document.querySelector<HTMLElement>('[data-portfolio-hero-content]')
      const heroImage = document.querySelector<HTMLElement>('[data-portfolio-hero-image]')
      const heroBg = document.querySelector<HTMLElement>('[data-portfolio-hero-bg]')
      const qualityBg = document.querySelector<HTMLElement>('[data-portfolio-quality-bg]')
