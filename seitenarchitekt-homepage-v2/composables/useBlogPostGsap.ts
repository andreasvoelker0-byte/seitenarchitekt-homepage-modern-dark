...
export const useBlogPostGsap = () => {
  ...
  const initAnimations = () => {
    ...
    ctx = gsap.context(() => {
      ...
      const heroContent = document.querySelector<HTMLElement>('[data-blog-post-hero-content]')
      const heroImage = document.querySelector<HTMLElement>('[data-blog-post-hero-image]')
      const heroBg = document.querySelector<HTMLElement>('[data-blog-post-hero-bg]')
