...
export const useAboutGsap = () => {
  ...
  const initAnimations = () => {
    ...
    ctx = gsap.context(() => {
      ...
      const heroBg = document.querySelector<HTMLElement>('[data-about-hero-bg]')
      const whyBg = document.querySelector<HTMLElement>('[data-about-why-bg]')
