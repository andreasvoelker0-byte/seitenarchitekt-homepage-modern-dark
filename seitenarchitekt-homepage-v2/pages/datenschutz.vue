...
useHead({
  title: 'Datenschutz | SeitenArchitekt Berlin',
  meta: [
    {
      name: 'description',
      content: 'Datenschutzerklärung von SeitenArchitekt.'
    }
  ]
})
</script>
...
<template>
  <div class="relative overflow-hidden">
    ...
    <main class="pt-32 sm:pt-36 lg:pt-40">
      <section class="pb-24 sm:pb-28 lg:pb-32">
        <div class="container-shell">
          <article class="panel mx-auto max-w-5xl p-8 sm:p-10 lg:p-14">
            <p class="section-label">Rechtliches</p>
            <h1 class="section-title mt-6 text-4xl sm:text-5xl">Datenschutzerklärung</h1>

            <div class="mt-10 space-y-10 text-base leading-8 text-[var(--muted)]">
              <section class="space-y-4">
                <h2 class="text-2xl font-semibold text-white">1. Datenschutz auf einen Blick</h2>
                <h3 class="text-xl font-semibold text-white">Allgemeine Hinweise</h3>
                <p>
                ...
                <h3 class="text-xl font-semibold text-white">Datenerfassung auf dieser Website</h3>
                ...
                <h3 class="text-xl font-semibold text-white">Wie erfassen wir Ihre Daten?</h3>
                <p>
                ...
                <h3 class="text-xl font-semibold text-white">Wofür nutzen wir Ihre Daten?</h3>
                <p>
                  ...
                  werden die übermittelten Daten auch für Vertragsangebote, Bestellungen oder
              ...
              <section class="space-y-4">
                <h2 class="text-2xl font-semibold text-white">2. Hosting</h2>
                <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
                <h3 class="text-xl font-semibold text-white">Externes Hosting</h3>
                <p>
                ...
                <h3 class="text-xl font-semibold text-white">Auftragsverarbeitung</h3>
                <p>
              ...
              <section class="space-y-4">
                ...
                <h3 class="text-xl font-semibold text-white">Datenschutz</h3>
                <p>
                ...
                <h3 class="text-xl font-semibold text-white">Hinweis zur verantwortlichen Stelle</h3>
                <p>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p>
                <p>
                  National Road 6, Slar Kram Village, Sangkat Slar Kram, Siem Reap City-Province<br>
                  17251 Siem Reap
                </p>
                <p>
                  Telefon: +85516358011<br>
                  E-Mail: andreas.seitenarchitekt@gmail.com
                </p>
                <p>
                ...
                <h3 class="text-xl font-semibold text-white">Speicherdauer</h3>
                <p>
                ...
                <h3 class="text-xl font-semibold text-white">Empfänger von personenbezogenen Daten</h3>
                <p>
                ...
                <h3 class="text-xl font-semibold text-white">Auskunft, Berichtigung und Löschung</h3>
                <p>
                ...
                <h3 class="text-xl font-semibold text-white">Widerspruch gegen Werbe-E-Mails</h3>
                <p>
              ...
              <section class="space-y-4">
                <h2 class="text-2xl font-semibold text-white">4. Datenerfassung auf dieser Website</h2>
                ...
                <p>
                  ...
                  (z. B. die Warenkorbfunktion oder die Anzeige von Videos). Andere Cookies können
                ...
                <p>
                  ...
                  Webpublikums) erforderlich sind (notwendige Cookies), werden auf Grundlage von
                ...
                <h3 class="text-xl font-semibold text-white">Kontaktformular</h3>
                <p>
                ...
                <h3 class="text-xl font-semibold text-white">Anfrage per E-Mail, Telefon oder Telefax</h3>
                <p>
              ...
              <section class="space-y-4">
                <h2 class="text-2xl font-semibold text-white">5. Analyse-Tools und Werbung</h2>
                <h3 class="text-xl font-semibold text-white">WP Statistics</h3>
                <p>
                  ...
                  (<a
                    class="text-white underline underline-offset-4 transition hover:text-[var(--accent)]"
                ...
                <p>
                  ...
                  Statistics erfasst dabei u. a. Logdateien (IP-Adresse, Referrer, verwendete
                  Browser, Herkunft des Nutzers, verwendete Suchmaschine) und Aktionen, die die
                ...
                <h3 class="text-xl font-semibold text-white">IP-Anonymisierung</h3>
                <p>
