import { _ as _sfc_main$1$1, h as homeContent, a as _sfc_main$4 } from './homeContent-BdSxHlsL.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-DYbrFFRo.mjs';
import { defineComponent, computed, watchEffect, unref, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const post = computed(() => {
      var _a;
      return (_a = blogContent.posts.find((item) => item.slug === slug.value)) != null ? _a : null;
    });
    useHead(() => {
      var _a, _b, _c, _d;
      return {
...
//# sourceMappingURL=_slug_-Bsfis23D.mjs.map
