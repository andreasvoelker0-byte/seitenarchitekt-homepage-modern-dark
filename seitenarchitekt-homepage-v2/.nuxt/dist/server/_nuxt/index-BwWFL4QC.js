import { _ as _sfc_main$c, h as homeContent, a as _sfc_main$d } from "./homeContent-BdSxHlsL.js";
import { _ as __nuxt_component_0 } from "./nuxt-link-DYbrFFRo.js";
import { defineComponent, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext, ref, unref } from "vue";
  ...
  setup(__props) {
    ...
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "Seiten Architekt Berlin erstellt professionelle Websites für Handwerksbetriebe: klare Struktur, starke Nutzerführung und SEO für mehr qualifizierte Anfragen."
        }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_SolutionModal, {
        ...
        content: unref(homeContent).problems.modal,
...
//# sourceMappingURL=index-BwWFL4QC.js.map
