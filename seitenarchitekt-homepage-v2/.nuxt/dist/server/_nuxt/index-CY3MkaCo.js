import { _ as _sfc_main$6, h as homeContent, a as _sfc_main$7 } from "./homeContent-BdSxHlsL.js";
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Beitrag öffnen <span${_scopeId}>→</span>`);
          } else {
            return [
              createTextVNode(" Beitrag öffnen "),
              createVNode("span", null, "→")
            ];
          }
        }),
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "py-24 sm:py-28" }, _attrs))}><div class="container-shell"><div data-reveal class="panel relative overflow-hidden px-8 py-12 sm:px-10 sm:py-14 lg:px-14 lg:py-16"><div class="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(201,167,106,0.14),transparent_34%),linear-gradient(135deg,rgba(255,255,255,0.02),transparent_52%)]"></div><div class="relative flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between"><div class="max-w-3xl"><span class="section-label">Nächster Schritt</span><h2 class="section-title mt-8">${ssrInterpolate(__props.content.title)}</h2><p class="section-copy mt-8">${ssrInterpolate(__props.content.copy)}</p></div><div class="flex flex-col gap-4 sm:flex-row sm:items-center lg:flex-col lg:items-start xl:flex-row xl:items-center">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: __props.content.primaryCta.to,
        class: "gold-button"
      }, {
...
//# sourceMappingURL=index-CY3MkaCo.js.map
