import { _ as _sfc_main$1$1, h as homeContent, a as _sfc_main$8 } from './homeContent-Bg8Wqbvz.mjs';
...
const aboutContent = {
  seo: {
    title: "\xDCber mich | SeitenArchitekt Berlin",
    description: "Erfahre mehr \xFCber SeitenArchitekt: Webdesign-Freelancer aus Berlin f\xFCr Handwerksbetriebe, die ihre Website professionell erstellen lassen m\xF6chten und Wert auf klare Nutzerf\xFChrung legen."
  },
  hero: {
    badge: "\xDCber mich \xB7 Website-Projekte f\xFCr Handwerker",
    titleLead: "Ich begleite Betriebe dabei, ihre",
    titleAccent: "Website professionell erstellen zu lassen",
    copy: "Ich unterst\xFCtze Handwerksunternehmen dabei, online vertrauensw\xFCrdig aufzutreten, klare Leistungen zu zeigen und aus Besuchern konkrete Anfragen zu machen.",
  ...
  intro: {
    label: "Pers\xF6nliche Vorstellung",
    title: "Strategisches Webdesign f\xFCr Handwerksbetriebe mit klarem Praxisbezug",
    columns: [
      [
        "Ich arbeite seit mehreren Jahren als Webdesigner in Berlin und unterst\xFCtze kleine und mittlere Betriebe dabei, ihre Website strategisch neu aufzustellen. Mein Schwerpunkt liegt auf Unternehmen, die keine Marketingabteilung brauchen, sondern eine klare, funktionierende L\xF6sung.",
        "Gerade im Handwerk entscheidet der erste Eindruck online oft dar\xFCber, ob ein Interessent anruft oder weitersucht. Deshalb entwickle ich Seiten, die Leistungen klar erkl\xE4ren, Kompetenz zeigen und den n\xE4chsten Schritt zur Kontaktaufnahme einfach machen."
      ],
      [
        "Meine Projekte sind bewusst praxisnah aufgebaut: verst\xE4ndliche Inhalte, saubere Struktur, mobiloptimierte Darstellung und klare Nutzerf\xFChrung. Kein Design um des Designs willen, sondern eine Website, die im Alltag arbeitet und Vertrauen schafft.",
        "Ich arbeite partnerschaftlich, direkt und transparent. Du wei\xDFt jederzeit, was als N\xE4chstes passiert, welche Entscheidungen sinnvoll sind und worauf wir verzichten k\xF6nnen."
      ]
    ]
  },
  approach: {
    ...
    copy: "Ein klarer Ablauf sorgt daf\xFCr, dass die Website nicht nur gut aussieht, sondern im Alltag Ergebnisse bringt.",
    items: [
      {
        title: "1. Klarheit vor Gestaltung",
        copy: "Wir definieren zuerst Zielgruppe, Leistungen und Kernbotschaften. Danach entsteht ein Design, das diese Inhalte unterst\xFCtzt."
      },
      {
        title: "2. Vertrauen sichtbar machen",
        copy: "Referenzen, regionale N\xE4he, nachvollziehbare Leistungsbeschreibungen und klare Kontaktwege stehen im Mittelpunkt."
      },
      {
        title: "3. Nutzerf\xFChrung mit System",
        copy: "Jede Seite hat ein Ziel. Besucher werden strukturiert von der Information zur konkreten Anfrage gef\xFChrt."
      },
      {
  ...
  why: {
    ...
    items: [
      ...
      {
        title: "Verst\xE4ndliche Kommunikation",
        copy: "Klare Entscheidungen ohne Fachjargon. Du bekommst nachvollziehbare Empfehlungen statt technischer \xDCberfrachtung."
      },
      {
        title: "Professioneller Auftritt",
        copy: "Die Website vermittelt Qualit\xE4t, Zuverl\xE4ssigkeit und Struktur. So entsteht Vertrauen bereits vor dem ersten Gespr\xE4ch."
      }
    ],
  ...
  values: {
    ...
    items: [
      ...
      },
      {
        ...
        copy: "Ich empfehle nur Ma\xDFnahmen, die f\xFCr dein Unternehmen sinnvoll sind und wirklich Wirkung entfalten."
      },
      {
        title: "Langfristiger Nutzen",
        copy: "Deine Website wird so aufgebaut, dass sie auch in zwei oder drei Jahren noch tragf\xE4hig und erweiterbar ist."
      }
    ]
  },
  personal: {
    ...
    paragraphs: [
      "Ich wei\xDF, dass in Handwerksbetrieben wenig Zeit f\xFCr lange Abstimmungen bleibt. Deshalb halte ich Prozesse schlank, bereite Entscheidungen sauber vor und arbeite mit klaren Priorit\xE4ten.",
      "Mein Anspruch ist, dass du nach dem Projekt nicht nur eine sch\xF6ne Website hast, sondern ein Werkzeug, das deine Leistungen professionell pr\xE4sentiert und die Kontaktaufnahme erleichtert. Genau deshalb verbinde ich Strategie, Inhalt und Gestaltung in einem klaren Prozess."
    ],
  ...
  finalCta: {
    ...
    copy: "Wenn du deine Website erstellen lassen m\xF6chtest und eine klare, professionelle L\xF6sung suchst, die zu deinem Betrieb passt und langfristig funktioniert, lass uns sprechen.",
    primaryCta: { label: "Kostenloses Erstgespr\xE4ch", to: "/#kontakt" },
...
//# sourceMappingURL=ueber-mich-q7LvxWGj.mjs.map
