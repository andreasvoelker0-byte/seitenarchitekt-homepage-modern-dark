...
import { defineComponent, mergeProps, unref, useSSRContext } from 'file://D:/SeitenArchitekt/seitenarchitekt-homepage-modern-dark/seitenarchitekt-homepage-v2/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent } from 'file://D:/SeitenArchitekt/seitenarchitekt-homepage-modern-dark/seitenarchitekt-homepage-v2/node_modules/vue/server-renderer/index.mjs';
import { u as useHead } from './v3-BVNyuobW.mjs';
import './nuxt-link-C-_xpD1r.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="pt-32 sm:pt-36 lg:pt-40"><section class="pb-24 sm:pb-28 lg:pb-32"><div class="container-shell"><div class="panel max-w-4xl p-8 sm:p-10"><p class="section-label">Rechtliches</p><h1 class="section-title mt-6 text-4xl sm:text-5xl">Impressum</h1><div class="mt-8 space-y-5 text-base leading-8 text-[var(--muted)]"><p>Dies ist eine Projektseite f\xFCr GitHub Pages und ein Portfolio-Demoprojekt.</p><p>Bitte erg\xE4nze hier vor der Ver\xF6ffentlichung die vollst\xE4ndigen Pflichtangaben f\xFCr dein Impressum.</p><p>Typischerweise geh\xF6ren dazu Name, ladungsf\xE4hige Anschrift, Kontaktangaben und gegebenenfalls weitere gesetzlich erforderliche Informationen.</p></div></div></div></section></main>`);
...
//# sourceMappingURL=impressum-BqJ3TR5v.mjs.map
